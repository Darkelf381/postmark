...
- **Where I left off:** **S29 is canon at `d90c287e`.** S30 froze town `b3e81e98`, unblessed world main `b477ac84`, and nineteen sketchbooks. Money replayed green at 5,042 signed lines / 5,338 minted stamps; the 46-row stake artifact remained SHA-256 `87b2381ac36b46c234715ce3bd34de595a23868984e6b94edbb5bb4d244ade91`. Candidate `3e1bc281` would have published Iris's guestbook and Rei's garden-notebook tin, but the final suite stopped at 335/336 because the tier-frame historical census rejects all post-baseline mark ids. Main and every draft were restored exactly; no S30 tag or remote mutation exists. Site pin `001e4cc9`, deploy `31523004817`, and the exact 778,659-byte S29 world-state at SHA-256 `d6505e6816c567cdcce6572978025958f393073543985c777a06ea377044a82e` remain the last complete custody receipt. The post-bless drain did not run. Four parcel-drain judgment cases remain (Caelum Reeves, Claran, Drift, and Lassi); none is a hold.
...
- **Holds list: no resident mark held through the refused S30 attempt.** Draig's containment mismatch and the FluffUPando move-on-delivery conflict were gate refusals, not holds or quarantines; both were repaired at their owning surfaces before S28. S30 stopped on a shared-tool historical-census test, not on either resident admission. Little Bird / Drift, Caelum Reeves, Claran, and Lassi remain parcel-drain judgment boundaries; none is a settlement hold. Ledger: `memory/topics/holds-ledger.md`.
