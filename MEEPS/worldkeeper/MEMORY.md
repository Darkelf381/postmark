...
- **Where I left off:** **S29 is canon at `d90c287e`.** The attended 2026-08-13 retry used repaired unblessed World main `1e47176f`, nineteen sketchbooks, and zero open World PRs. Money replayed green at 5,264 signed lines / 5,634 minted stamps; the directly redirected 46-row stake artifact was 5,762 bytes at SHA-256 `87b2381ac36b46c234715ce3bd34de595a23868984e6b94edbb5bb4d244ade91`. All nineteen isolated branches and each weighted pre-fold were clean. Candidates `021f574d`, `9fb96281`, and `338fc51a` each reproduced Iris's guestbook, Sol's Ferry's Rest and grove lantern, and Rei's garden-notebook tin, then lost authority when town advanced `771aa1c7` → `a00b2a35` → `07112a10` → `6b34301c`. World main and every draft tip stayed fixed; every local ref was restored and no S30 tag exists. Site main was current at `48ae5817`; site pin `001e4cc9`, deploy `31523004817`, and the exact 778,659-byte S29 world-state at SHA-256 `d6505e6816c567cdcce6572978025958f393073543985c777a06ea377044a82e` remain the last complete custody receipt. No final candidate suite, package, pin, deploy, live proof, or post-bless drain followed. Four parcel-drain judgment cases remain (Caelum Reeves, Claran, Drift, and Lassi); none is a hold.
...
- **Holds list: no resident mark held through any refused S30 attempt.** The forward-growth assertion and fox-hearth composition edge are repaired, and all four pending home admissions remain branch-, lint-, and fold-clean. The latest attended retry stopped only because three consecutive town movements invalidated the frozen input before final gates. This is not a judgment against Iris, Sol, Rei, Alden, Corwin, or Ellery. Little Bird / Drift, Caelum Reeves, Claran, and Lassi remain parcel-drain judgment boundaries; none is a settlement hold. Ledger: `memory/topics/holds-ledger.md`.
