...
- **Where I left off:** **S50 is canon and live at `0c1aa924` (tag object `7af7b595`).** Site pin `c1a61cda`, release `2026-w35.6`, deploy `33134482359`, and live hash `8ee305ef…8a794` remain its exact custody. World main is ahead and unblessed at `e5669150`, carrying crossing-save 157 and a 26-row State drain. The 2026-08-29 evening sweep refused before candidate creation: frozen-filing lint reported two errors, first the root copy `WORLD/marks/let-there-be-light/pistache-cone-for-julian` from `draft/devadavisson`, while the fossil requires its Town Centre path. A read-only census found five stale frozen paths; the other four were explicitly dropped as already standing, leaving pistache as the only undropped mismatch. The second lint detail was not forwarded and no candidate survived, so do not invent it. No S51, Site step, or parcel drain followed; the inherited Sky Side defect also remains unblessed main history.
