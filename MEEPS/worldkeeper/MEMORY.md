...
- **Where I left off:** **S27 is still canon at `09e42d76`.** The 2026-08-11 06:00 attempt began from town `69843f77`, unblessed world main `3b3421b4`, and nineteen sketchbooks. Money replayed green at 4,868 signed lines / 5,158 minted stamps; the exact 46-row stake artifact was SHA-256 `16bd5552df47345f9c936aa8b2f68fc7a6aecad7e28a803d93c97c4b88277f14`. Main lint/fold and all nineteen rebases were green, but the sweep's settlement lint refused Draig's mismatched containment. No S28 tag, ref push, pin, deploy, or parcel drain followed. Every local draft ref was restored to its frozen remote tip. Site pin `a55855e2`, deploy `31418995091`, and the exact S27 live bytes remain the last complete custody receipt. Four parcel-drain judgment cases remain (Caelum Reeves, Claran, Drift, and Lassi). None is a hold.
...
- **Holds list: no resident mark held through S27 or the refused S28 attempt.** Draig's containment mismatch is a schema-gate refusal, not a hold or quarantine; the resident record remains untouched on the draft branch. Little Bird / Drift, Caelum Reeves, Claran, and Lassi remain parcel-drain judgment boundaries; none is a settlement hold. Ledger: `memory/topics/holds-ledger.md`.
