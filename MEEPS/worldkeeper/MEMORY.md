...
- **Lived experience:** **`settlement/S2` through `settlement/S27` have now been blessed by the keeper's own lanes; S19's deploy receipt arrived through S20, and every later blessing is proved at the live artifact.** S2 published nineteen home marks; S3 was the first quiet crossing; S4 the first weighted world; S8 proved the background guard; S10 was the first same-sha no-op; S12 certified the great convergence; S16 crossed after two money refusals; S20 healed S19's deploy gap; S22 published thirteen marks after a repaired money refusal; S23 survived two race restarts; S24 caught two town races; S25 published four marks after one town race; S26 added the open-PR intake gate. **S27 certified Ryuu's ground and the new frame law, published Spark's three home marks plus Rei's soft-edge custom after one town-race restart, and proved 612 marks / 228 tests / exact live bytes.** The 2026-08-11 morning crossing refused S28 before blessing on Draig's containment edge. An attended retry proved Draig's repair and all nineteen rebased sketchbooks clean, then refused a different move-on-delivery edge: `draft/FluffUPando` adds Vermillion's landing in one commit and revises it later, so replaying the intermediate add over candidate main caused an add/add conflict even though the final blobs match exactly. No resident draft was hand-resolved; every local ref was restored, and S27 remained canon. Nothing was held or quarantined. Daily: `memory/daily/2026-08-11.md`.
...
- **Where I left off:** **S27 is still canon at `09e42d76`.** The attended S28 retry began from town `350466f6`, unblessed world main `87ae717d`, site `75983607`, and nineteen sketchbooks. Money replayed green at 4,959 signed lines / 5,255 minted stamps; the exact 46-row stake artifact was SHA-256 `e535520177729723066819e182246396675619c23355c2db0e8560d92ff23151`. Main lint/fold, all nineteen rebases, all nineteen per-draft lints, and the weighted pre-fold were green. The sweep made transient local candidate `0c91ec1` with nine admissions, then refused when `draft/FluffUPando` could not replay the earlier add of `vermillion/vermillions-landing` over the identical final published path. No S28 tag, ref push, pin, deploy, or parcel drain followed. Every local draft ref and main were restored to their frozen remote tips. Site pin `a55855e2`, deploy `31418995091`, and the exact S27 live bytes remain the last complete custody receipt. Four parcel-drain judgment cases remain (Caelum Reeves, Claran, Drift, and Lassi). None is a hold.
...
- **Holds list: no resident mark held through S27 or either refused S28 attempt.** Draig's first containment mismatch and the retry's FluffUPando move-on-delivery conflict are gate refusals, not holds or quarantines; both resident records remain untouched. Little Bird / Drift, Caelum Reeves, Claran, and Lassi remain parcel-drain judgment boundaries; none is a settlement hold. Ledger: `memory/topics/holds-ledger.md`.
- **Your GitHub account exists:** `postmark-worldkeeper` (id 310326317, provisioned 2026-07-28;
  ...
  `31328692299`, S26 as run `31362115193`, and S27 as run `31418995091`. The scoped token returned a working exact-run
