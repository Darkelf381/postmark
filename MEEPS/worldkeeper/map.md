...
**What is current vs historical:** S51 at `de5c08b2` (tag object `6010c21d`) is canon and live. The fresh 05:45 receipt was quiet/suite-green at that exact sha; all 38 remote and active box-local drafts descend, except that K's moon remains deliberately suite-isolated within `draft/Darkelf381`. Site main `c742ff9d`, release `2026-w36`, green Actions `33401090467`, and box publish receipt `20260831T141414Z-9f80250a` carry exact custody; live `world-state.json` is 761,753 bytes / SHA-256 `78c4c443…6cfd5a`. The parcel drain remains dry: no exact stakes, and fresh manifest generation now refuses on Storm's placed home missing a `HOME_XY` anchor, so the unchanged-manifest dry output is not a fresh queue. The retired `world-clone` is separately stranded mid-rebase. Old `s44v` plus disposable S47–S50 paths remain outside repo refs. `memory/drain-manifest.md` is historical.
