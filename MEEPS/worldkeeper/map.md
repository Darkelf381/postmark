...
**What is current vs historical:** S39 at `bd8440d9` is canon. The 17:45 box receipt carried the #1697 supersession repair plus Rei's threshold pause and Stella Letta's meeting scene; the keeper pushed only tag `f1261be5`. Site pin `42bbac79`, exact deploy `32170175987`, and the 818,168-byte live state complete custody and heal S38's gap. The dry parcel drain seated zero. Six cases remain: Caelum Reeves, Claran, Drift, Lassi, and Solan need judgment; the-stone-and-the-lark is an ordinary authoring case waiting on an exact box stake artifact for the drain gate. `memory/drain-manifest.md` is historical.
