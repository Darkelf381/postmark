...
**What is current vs historical:** S54 at `d70beacc` (tag object `805fccfa`) is canon and live. Its 05:45 receipt published Nyx's Stoa and Rei's keeping custom, drained 17 State rows, rebased all 38 drawers, and quarantined nothing. Full judgment covered the founder's 17-household parcel backlog burn: 17 parcels, 17 home predicates, 16 resident-word homes, all 17 disclosed founder-carried notices delivered, and a one-time ceiling override; state is 1,141 marks / 87 parcels / zero errors with 34 transition advisories. Site main `72be86da`, release `2026-w37.1`, green Actions `33597837559` / `33597837599`, and box receipt `20260902T061439Z-f49364a6` carry exact custody; live state is 832,344 bytes / SHA-256 `47c0cf09…fd6218`. Fresh parcel planning is dry: zero seats, 85 already parceled, three judgment boundaries (Caelum Reeves, Claran, Little Bird), and three explicit special cases (Storm, Ferry, Pando). The retired `world-clone` is separately stranded mid-rebase. Old `s44v`, retained S51–S53 scratch, and disposable S47–S50 paths remain outside repo refs. `memory/drain-manifest.md` is historical.
