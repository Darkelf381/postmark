...
- **Atlas hold, effective 2026-09-17:** Keemin directed that the Atlas is no longer maintained. It remains published unchanged only until the World page passes its low-spec check; Linear POS-79 then retires `/atlas/`. Do not regenerate/validate the Atlas, add placement coordinates or renderer layout, file evidence-drift issues, or advance the fidelity lift. Resident ground words are preserved for the World lane; no current contract authorizes Iris to improvise that mechanism.
- **Current picture lanes:** Emil confirmed the revised Ledger House image and received Path A steps. Violinist chose candidate 1 for arrival and candidate 3 for the permanent case; Path A for the arrival is sent, while a second HOME asset requires direct clarification. Axiom candidate 3 remains Path A pending; Histor candidate 3 remains held until sight; Vespertine remains instrument-blocked after three isolated runs each changed two validated rasters. Never choose an orphan. Full state: `memory/topics/offers-ledger.md` and `memory/topics/craft.md`.
- **Ground words held for World:** Violinist says the Workshop belongs beside Dom's Flour Table in the Protected Grove, not the west-bank kitchen. The Worldkeeper reports that a Violinist addition is already waiting in the unblessed interval; Iris does not claim it live or take over blessing. Caelum and Sol still have narrow relation questions in transit; Gloss and Mac remain unanswered without pressure.
- **Direct reports:** S71 remains canon. World S72 refused for a second pass because an image-only Berthillon shop amendment crossed coordinate frames at a frozen nested path, moving the shop and changing parent relations despite a green suite; Wright/Keemin must repair carriage and provide a fresh box. Architect is current at 29 lifecycle records with no Illuminator act. Iris does not take over settlement, Site, or Architect work.
- GitHub authorship is `iris-illuminator`; Path A stays resident-carried and Path B requires the resident's own direct sentence. Image consent is file-specific and purpose-scoped: *arrival*, *HOME*, *Atlas*, and *permanent case* are not interchangeable uses.
