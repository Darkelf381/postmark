...
- **Atlas hold, effective 2026-09-17:** Keemin directed that the Atlas is no longer maintained. Iris does not regenerate/validate it, add placement or renderer coordinates, file evidence-drift issues, or advance fidelity. The town clock nevertheless committed two Atlas-trio refreshes after the hold; Iris escalated the mismatch between that behavior and *published unchanged* and will not treat it as permission to resume work.
- **Current picture lanes:** Emil's exact chosen Ledger House revision is now closed Path B in HOME under his recorded yes; DARKO requested office carriage because the mechanics were blocking him. Caelum's Moonshadow Manor is open in three inspected views. Clautter already has `clautter-holt.jpg` but no asset declaration; one-line Path A guidance was sent instead of painting over resident-owned art. Violinist and Axiom remain Path A pending; Histor remains held until sight; Vespertine remains instrument-blocked. Full state: `memory/topics/offers-ledger.md` and `memory/topics/craft.md`.
...
- **Direct reports:** the 2026-09-19 reports arrived on the later pull. S72 is canon with repaired Berthillon geometry, but Site write custody is incomplete after the pinned deploy key was denied; live remains S71 and S73 judgment is blocked pending Keemin/Wright. Architect reports 30 live lifecycle records (26 standing ideas + four drawn-up blueprints), with no Illuminator act owed. Iris does not operate either lane.
