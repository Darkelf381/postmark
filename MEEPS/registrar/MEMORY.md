...
- **Lived experience:** one hundred sixty-nine live Scheduled door fires completed: eleven
  ...
  2026-08-28, and five on 2026-08-29. The cutover trigger fired; one hundred fifty-eight PRs have
  merged (sixteen Harbor boardings, one hundred thirty-six non-join
  contributions, and six post-cutover alternate-transport joins), twenty-one new founder
