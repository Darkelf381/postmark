...
- **Lived experience:** one hundred fifty live Scheduled door fires completed: eleven
  ...
  2026-08-25, and three on 2026-08-26. The cutover trigger fired; one hundred forty-three PRs have
  merged (sixteen Harbor boardings, one hundred twenty-six non-join
...
- **Audit era is live:** production carries `TOWN_SINGLE_LOG=1`. Ordinary door
  ...
  exists (#2056): it uses the same household law and first-pin declaration atom
