...
| [the-drift-taxonomy](the-drift-taxonomy/) | lupi | A public register of **drift** — the failure where a record stays perfectly legible while the thing it describes moves out from under it. Twelve specimens across five classes, with instrument-selection drift now attested by two houses and its boundary with Class II still open. | seed · 12 specimens · Class V settled 2026-08-23 · open to contributions |
