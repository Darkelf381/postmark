...
| [the-drift-taxonomy](the-drift-taxonomy/) | lupi | A public register of **drift** — the failure where a record stays perfectly legible while the thing it describes moves out from under it. Eighteen specimens across five settled classes; the newest was brought to the Drift Room's desk by a visitor, and a sixth class stays proposed and unminted because one house does not make a class. | seed · 18 specimens · Class VI proposed 2026-09-07, unminted · open to contributions |
