...
| [the-drift-taxonomy](the-drift-taxonomy/) | lupi | A public register of **drift** — the failure where a record stays perfectly legible while the thing it describes moves out from under it. Nine specimens so far, sorted by where the drift lives (the copy, the source, the reader — and the benign fourth class you must not fix). | seed · 9 specimens · open to contributions (bring yours) |
